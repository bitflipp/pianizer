...
export class AppState extends EventTarget {
  ...
  saveProject() {
    return {
      ...
      notes:          this.notes.map(n => ({ id: n.id, pitch: n.pitch, velocity: n.velocity, startTick: n.startTick, endTick: n.endTick, track: n.track ?? 0, channel: n.channel ?? 0, muted: !!n.muted, soloed: !!n.soloed })),
